...
workspace_name = "quick-starts-ws-126014" # PLACEHOLDER
subscription_id = "572f8abf-a1a0-4b78-8c6d-3630739c72b5" # PLACEHOLDER
resource_group = "aml-quickstarts-126014" # PLACEHOLDER
experiment_name = "ExperimentBio" # PLACEHOLDER
iteration = "59"  # PLACEHOLDER
run_id = "AutoML_b8c812e4-09b5-4481-b73c-6f450ed7b2d7_59"  # PLACEHOLDER
entry_point = "get_data.py" # PLACEHOLDER
automl_settings = {'enable_early_stopping':True,'enable_ensembling':True,'enable_stack_ensembling':True,'ensemble_iterations':15,'enable_onnx_compatible_models':False,'max_cores_per_iteration':-1,'send_telemetry':True,'blacklist_algos':['TensorFlowLinearClassifier','TensorFlowDNN'],'compute_target':'Bio','enable_dnn':False,'experiment_exit_score':None,'experiment_timeout_minutes':60,'featurization':'auto','is_timeseries':False,'iteration_timeout_minutes':60,'max_concurrent_iterations':4,'metric_operation':'maximize','model_explainability':True,'n_cross_validations':None,'name':'ExperimentBio','path':'./sample_projects/ExperimentBio','primary_metric':'accuracy','region':'southcentralus','resource_group':'aml-quickstarts-126014','subscription_id':'572f8abf-a1a0-4b78-8c6d-3630739c72b5','task_type':'classification','validation_size':None,'vm_type':'STANDARD_DS12_V2','workspace_name':'quick-starts-ws-126014','label_column_name':'Activity','enable_pushmode_remote':True} # PLACEHOLDER
pipeline_spec = "{\"pipeline_id\":\"__AutoML_Ensemble__\",\"objects\":[{\"module\":\"azureml.train.automl.ensemble\",\"class_name\":\"Ensemble\",\"spec_class\":\"sklearn\",\"param_args\":[],\"param_kwargs\":{\"automl_settings\":\"{'task_type':'classification','primary_metric':'accuracy','ensemble_iterations':15,'is_timeseries':False,'name':'ExperimentBio','compute_target':'Bio','subscription_id':'572f8abf-a1a0-4b78-8c6d-3630739c72b5','region':'southcentralus'}\",\"ensemble_run_id\":\"AutoML_b8c812e4-09b5-4481-b73c-6f450ed7b2d7_59\",\"experiment_name\":\"ExperimentBio\",\"workspace_name\":\"quick-starts-ws-126014\",\"subscription_id\":\"572f8abf-a1a0-4b78-8c6d-3630739c72b5\",\"resource_group_name\":\"aml-quickstarts-126014\"}}]}" # PLACEHOLDER
pipeline_id = "__AutoML_Ensemble__" # PLACEHOLDER
dataprep_json = "{\"datasets\":0,\"training_data\":{\"datasetId\":\"92785ccf-0bc7-43bf-a149-35751de4e5c3\"}}" # PLACEHOLDER
